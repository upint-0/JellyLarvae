...
Shader "Custom/JellyShader"
{
	Properties
	{
		...
		[ASEEnd]_DistortTiling("DistortTiling", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float2 panner41 = ( _TimeParameters.x * float2( 0.01,-0.01 ) + ( IN.texCoord0.xy * _DistortTiling ));
				float2 uv_Voronoi8512x512 = IN.texCoord0.xy * _Voronoi8512x512_ST.xy + _Voronoi8512x512_ST.zw;
				float4 lerpResult32 = lerp( tex2D( _CameraSortingLayerTexture, ( (ase_grabScreenPosNorm).xy + ( ( ( (tex2D( _7524normal, panner41 )).rg + -0.5 ) * 2.0 ) * _DistortAmount ) ) ) , _JellyColor , tex2D( _Voronoi8512x512, uv_Voronoi8512x512 ).r);
...
/*ASEBEGIN
Version=18917
2560;357;1920;1011;4522.708;1628.727;2.729152;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-1391.421,-54.99947;Inherit;True;Property;_MainTex;_MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;c97bd54365246d8418c2a50d85b14f8b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=51A661D59FA55287837B87569A5B65845264BF33