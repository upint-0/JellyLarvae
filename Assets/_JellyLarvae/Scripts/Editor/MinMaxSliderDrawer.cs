...
public class MinMaxSliderDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label){
        ...
        label.tooltip = minMaxAttribute._Min.ToString("F2") + " to " + minMaxAttribute._Max.ToString("F2");
        ...
        if(propertyType == SerializedPropertyType.Vector2){ 
            ...
            minMaxAttribute._Min,minMaxAttribute._Max);

            if(minVal < minMaxAttribute._Min){
                minVal = minMaxAttribute._Min;
            }

            if(maxVal > minMaxAttribute._Max){
                maxVal = minMaxAttribute._Max;
            }
            ...
            if(minVal < minMaxAttribute._Min){
                maxVal = minMaxAttribute._Min;
            }

            if(minVal > minMaxAttribute._Max){
                maxVal = minMaxAttribute._Max;
            }
