	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = tex2D( _MainTex, ( floor( ( IN.texCoord0.xy * temp_output_57_0 ) ) / temp_output_57_0 ) );
...
/*ASEBEGIN
Version=18917
2585;382;1836;961;3577.483;707.5974;2.16251;True;False
...
Node;AmplifyShaderEditor.Vector2Node;28;-1854.039,49.91055;Inherit;False;Property;_Pixels;Pixels;1;0;Create;True;0;0;0;False;0;False;64,64;64,64;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;26;-2381.045,-57.64999;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=34AAFE26776EFCBC5AE0EAC0F1D0E97390F9E6BB