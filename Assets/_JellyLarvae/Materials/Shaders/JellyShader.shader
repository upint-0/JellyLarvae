	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( _JellyColor * tex2D( _MainTex, uv_MainTex ) );
...
/*ASEBEGIN
Version=18917
0;73;1238;687;1140.263;361.7144;1;True;False
